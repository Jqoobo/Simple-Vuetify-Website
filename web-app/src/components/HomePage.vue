<template>
    <v-container class="pt-15">
        <v-row>
            ...
            <v-col lg="6">
               <h2 class="intro-text text-left ml-15 d-none d-sm-flex">Poznaj Polskę!</h2>
               <h2 class="intro-text text-center ml-4 d-flex d-sm-none" style="margin-right:-1px">Poznaj Polskę!</h2> <br><br>
               <p class="opis d-none d-sm-flex d-sm-none d-md-flex ml-15 black--text">Nasza strona przedstawia najlepsze zakątki Polski oraz całe piekno naszego kraju! Odkryj cuda tego kraju już teraz!<br><br>Polska, oficjalnie Rzeczpospolita Polska, jest demokratycznym państwem w Europie Środkowej. Stolicą i największym miastem kraju jest Warszawa. Polska, z powierzchnią 312 696 km² jest dziewiątym, co do wielkości krajem w Europie i zajmuje 69 miejsce wśród największych państw świata. Od północy Polska graniczy z Rosją i Litwą, od wschodu z Białorusią i Ukrainą, od południa ze Słowacją i Czechami, od zachodu z Niemcami. Geograficznie Polska jest krajem nizinnym. Katolicy są zdecydowanie największą religią w kraju.</p>
               <p class="opis justify-center text-justify d-flex ml-6 mr-6 d-sm-none black--text" style="margin-right:-1%">Nasza strona przedstawia najlepsze zakątki Polski oraz całe piekno naszego kraju! Odkryj cuda tego kraju już teraz!<br><br>Polska, oficjalnie Rzeczpospolita Polska, jest demokratycznym państwem w Europie Środkowej. Stolicą i największym miastem kraju jest Warszawa. Polska, z powierzchnią 312 696 km² jest dziewiątym, co do wielkości krajem w Europie i zajmuje 69 miejsce wśród największych państw świata. Od północy Polska graniczy z Rosją i Litwą, od wschodu z Białorusią i Ukrainą, od południa ze Słowacją i Czechami, od zachodu z Niemcami. Geograficznie Polska jest krajem nizinnym. Katolicy są zdecydowanie największą religią w kraju.</p>
               <v-btn color="teal lighten-1" class="white--text mr-5 mt-10 ml-11" href="#/portfolio" rounded>Zacznij</v-btn>
               <v-btn color="teal darken-3" class="white--text mt-10 ml-"  rounded href="https://www.youtube.com/watch?v=ekz6i58kVpI">
